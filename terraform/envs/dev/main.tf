...
module "resolver_lambda" {
  ...
  function_name   = "bigeo-dev-resolver"
...
module "review_intake_lambda" {
  ...
  function_name   = "bigeo-dev-review-intake"
...
module "auth0_authorizer_lambda" {
  ...
  function_name   = "bigeo-dev-auth0-authorizer"
